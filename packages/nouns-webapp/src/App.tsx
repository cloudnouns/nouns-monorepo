...
import PropLotPage from './pages/PropLotPage';
      ...
      <BrowserRouter>
        ...
        >
          ...
          <Switch>
            ...
            <Route exact path="/proplot" component={PropLotPage} />
            <Route exact path="/proplot/create" component={PropLotPage} />
            <Route exact path="/proplot/:id" component={PropLotPage} />
